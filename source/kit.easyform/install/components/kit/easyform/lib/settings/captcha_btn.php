...
$obJSPopup = new CJSPopup('',
    array(
        'TITLE' => GetMessage('KIT_EASYFORM_FIELD_CAPTCHA_POPUP_TITLE'),
        'SUFFIX' => '',
        'ARGS' => ''
    )
);
...
<img style="border: 1px solid;" src="/bitrix/components/kit/easyform/images/instructions_step_2_1.png"
     alt="instructions"/>
<br>
<br>
...
$secretKey = \COption::GetOptionString('kit.easyform', 'CAPTCHA_SECRET_KEY', '', SITE_ID);
?>
...
<script>
    $(document).ready(function () {
        ...
        $(".submit_captcha").on("click", function () {
            ...
            $.ajax({
                url: "/bitrix/components/kit/easyform/lib/settings/captcha_btn.php",
                type: 'POST',
                data: data
            });
        });
...
if ($REQUEST_METHOD == 'POST') {
    ...
    \COption::SetOptionString('kit.easyform', 'CAPTCHA_KEY', htmlspecialchars($_POST['captcha_key_val']), false, SITE_ID);
   \COption::SetOptionString('kit.easyform', 'CAPTCHA_SECRET_KEY', htmlspecialchars($_POST['captcha_secret_key_val']), false, SITE_ID);
}
?>