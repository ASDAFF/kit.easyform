...
class Options
{
    ...
    public function __construct($module_id, $aSitesTabs,  $arTabs, $arGroups, $arOptions, $need_access_tab = false)
    {
        ...
        if($need_access_tab)
            $this->arTabs[] = array(
                'DIV' => 'edit_access_tab',
                'TAB' => Loc::getMessage('KIT_EASYFORM_EDIT_ACCESS_TAB'),
                'ICON' => '',
                'TITLE' => Loc::getMessage('KIT_EASYFORM_EDIT_ACCESS_TITLE'),
            );
    ...
    public function ShowHTML()
    {
        ...
        if(is_array($this->arOptions))
        {
            ...
            echo     '<input type="hidden" name="update" value="Y" />
                                      <input type="submit" name="save" value="'.Loc::getMessage('KIT_EASYFORM_SAVE').'" />
                                      <input type="reset" name="reset" value="'.Loc::getMessage('KIT_EASYFORM_RESET').'" />';
