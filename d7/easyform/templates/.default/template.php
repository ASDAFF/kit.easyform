...
<div class="kit-easyform<?= $arParams['HIDE_FORMVALIDATION_TEXT'] == 'Y' ? ' hide-formvalidation' : '' ?>" <?= $WITH_FORM ?>>
    <form id="<?= $FORM_ID ?>"
    ...
    >
        <div class="alert alert-success <?php if ($arResult['STATUS'] != 'ok') { ?>hidden<?php } ?>" role="alert">
            <?= $arParams['OK_TEXT'] ?>
        </div>
        <div class="alert alert-danger <?php if ($arResult['STATUS'] != 'error') { ?>hidden<?php } ?>" role="alert">
            <?= $arParams['ERROR_TEXT'] ?>
